<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearCheque.aspx.cs" Inherits="YaguareteSystem.UI.Cheque.Cheque.CrearCheque" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <form runat="server">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Cargar nuevo cheque</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <h5>Proveedor</h5>
                                                <asp:DropDownList Style="width: 100%;" ID="ddlProveedor" CssClass="form-control select2bs4" runat="server" DataSourceID="sdsProveedor" DataTextField="denominacionProveedor" DataValueField="rucProveedor"></asp:DropDownList>
                                            </div>
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <input id="txtFechaEmision" disabled="disabled" runat="server" class="date-picker form-control" placeholder="dd/mm/aaaa" type="text">
                                                <asp:CompareValidator runat="server" ID="cvFecha1"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <h5>Fecha de pago</h5>
                                                <input id="txtFechaPago" disabled="disabled" runat="server" class="date-picker form-control" placeholder="dd/mm/aaaa" type="text">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <input id="txtFechaPromFactura" disabled="disabled" runat="server" class="date-picker form-control" placeholder="dd/mm/aaaa" type="text">
    ...
    <asp:SqlDataSource runat="server" ID="sdsCuentaCorriente" ConnectionString="<%$ ConnectionStrings:conStringCysaCheque %>" SelectCommand="select '-1' codigoCuentaCorriente, 'Seleccione...' cuentaCorriente union all
    ...
    <body>
        <form runat="server">
            <div class="container-fluid p-0">
                <h1 class="h3 mb-3">Cargar nuevo cheque</h1>
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
