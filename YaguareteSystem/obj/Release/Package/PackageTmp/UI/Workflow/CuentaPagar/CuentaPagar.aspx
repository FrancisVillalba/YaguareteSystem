<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CuentaPagar.aspx.cs" Inherits="YaguareteSystem.UI.Workflow.CuentaPagar.CuentaPagar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <form runat="server">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Lista de Cuentas a pagar</h3>
                            </div>
                            <div class="card-body">
    ...
    <asp:Label runat="server" CssClass="text-white" ID="lblCargado" Visible="false"></asp:Label>
    ...
    <script type="text/javascript">  
        ...
        function cargaTabla() {
            ...
            $.ajax(settings).done(function (response) {
                ...
                $('#headerTabla').append("<tr><th>ID</th><th>Nro. Factura</th> <th>Nro. OC</th> <th>Departamento</th> <th>Tipo legajo</th> <th>Tipo factura</th> <th>Solicitante</th><th>Comprador</th> <th>Proveedor</th><th>Fecha ingreso</th> <th>Empresa</th> <th>Fecha factura</th> <th>Acción</th>  <th><i class='fa fa-bars'></i></th> </tr >");
                $('#footTabla').append("<tr><th>ID</th><th>Nro. Factura</th> <th>Nro. OC</th> <th>Departamento</th> <th>Tipo legajo</th> <th>Tipo factura</th> <th>Solicitante</th><th>Comprador</th>  <th>Proveedor</th><th>Fecha ingreso</th> <th>Empresa</th> <th>Fecha factura</th> <th>Acción</th>  <th><i class='fa fa-bars'></i></th> </tr >");
                //debugger;
        ...
        $("#example1").on("click", "#btnProcesar", function () {
            ...
            window.location.replace("/UI/Workflow/CuentaPagar/ModificarCuentaPagar.aspx?ID=" + valores);
        })
    </script>
</asp:Content>
