<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VistaImportado.aspx.cs" Inherits="YaguareteSystem.UI.Workflow.Tesoreria.VistaImportado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Vista de datos importados</h1>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                    ...
                    <form runat="server">
                        <div class="card card-dark">
                            <div class="card-header">
                                <h3 class="card-title">Vista de datos importados</h3>
    ...
    <script type="text/javascript"> 
        ...
        function cargaTabla() {
            ...
            var cargaValores = "";
            //var contenido;
            var departamento = "TesoreriaVistaDatosImportados";
            debugger;
            var settings = {
            ...
            $.ajax(settings).done(function (response) {
                ...
                $.each(response.d, function (ind, elem) {
                    ...
                    var contenidoAux = "<tr>" + cargacolumnas + "<td><input id='checkProcesar' name='cuenta1' type='checkbox'></td></tr>";

                    $('#bodyTabla').append(contenidoAux);
                });
                $('#headerTabla').append("<tr><th>ID</th><th>Nro. Factura</th><th>Nro. OC</th><th>Tipo legajo</th> <th>Tipo factura</th> <th>Proveedor</th><th>Nro. Asiento</th><th>Acción</th><th>Empresa</th><th>Estado</th><th><a href='#' target='_blank'><i class='fa fa-file-pdf' aria-hidden='true'></i></a></th><th><input id='checkProcesarAll' onclick='checkAll(this)' name='cuenta1' type='checkbox'></th></tr >");
                $('#footTabla').append("<tr><th>ID</th><th>Nro. Factura</th><th>Nro. OC</th><th>Tipo legajo</th> <th>Tipo factura</th> <th>Proveedor</th><th>Nro. Asiento</th><th>Acción</th><th>Empresa</th><th>Estado</th><th><a href='#' target='_blank'><i class='fa fa-file-pdf' aria-hidden='true'></i></a></th><th>...</th> </tr >");
        ...
        function procesarMasivamente() {
            ...
            $.each(arrayValues1, function (i, elem) {
                ...
                $.ajax(settings).done(function (response) {
                    ...
                    window.location.replace("/UI/Workflow/Tesoreria/VistaImportado.aspx");
                });
