<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModificarTesoreria.aspx.cs" Inherits="YaguareteSystem.UI.Workflow.Tesoreria.ModificarTesoreria" %>
                                ...
                                <div class="card card-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <h5>Monto factura</h5>
                                                <asp:TextBox runat="server" Enabled="false" OnTextChanged="txtMontoTotal_TextChanged" AutoPostBack="true" ID="txtMontoTotal" placeholder="Monto total" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <br />
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <h5>Tipo moneda</h5>
                                                <asp:DropDownList runat="server" ID="ddlMoneda" CssClass="form-control" Enabled="false" DataSourceID="sdsMoneda" DataTextField="monDescripcion" DataValueField="monID"></asp:DropDownList>
