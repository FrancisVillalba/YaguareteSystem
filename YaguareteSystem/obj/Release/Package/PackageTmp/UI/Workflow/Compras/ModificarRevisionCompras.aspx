<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModificarRevisionCompras.aspx.cs" Inherits="YaguareteSystem.UI.Workflow.Compras.ModificarRevisionCompras" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Datos de Revisión por compras</h1>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
