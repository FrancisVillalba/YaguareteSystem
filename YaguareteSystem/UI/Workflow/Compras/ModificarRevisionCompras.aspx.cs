...
{
    public partial class ModificarRevisionCompras : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (lblControl.InnerText == "")
            {
                ...
                lblDepartamento.Text = "RevisionCompras";
            ...
            try
            {
                ...
                if (mensaje == "OK")
                {
                    ...
                    sharePoint.ActualizaMotivosRevisionCompras(Convert.ToInt64(lblID.Text), Session["usuario"].ToString(), Session["pass"].ToString(),txtComentarios.Value,Session["NombreApellido"].ToString(),
                        ...
                        "SI", "Revisión por compras", lblTipoGestion.Text);

                    lg.insertarComentario(Session["NombreApellido"].ToString(), Convert.ToInt32(lblID.Text), txtComentarios.InnerText, ddlNroOC.SelectedValue, lblTipoGestion.Text, ddlMovimiento.SelectedItem.ToString(), "Revisión compras", ddlDepartamento.SelectedItem.ToString());

                    lg.insertarDatosReporteStatusFacturaPowerBI("Revisión compras", ddlDepartamento.SelectedItem.ToString(), Convert.ToInt32(lblID.Text), Session["NombreApellido"].ToString(),
