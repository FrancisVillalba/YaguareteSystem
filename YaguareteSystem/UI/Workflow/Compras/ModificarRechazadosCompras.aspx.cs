...
{
    public partial class ModificarRechazadosCompras : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (lblControl.InnerText == "")
            {
                ...
                lblDepartamento.Text = "RechazadosCompras";
            ...
            try
            {
                ...
                if (mensaje == "OK")
                {
                    ...
                    sharePoint.ActualizaMotivosRevisionCompras(Convert.ToInt64(lblID.Text), Session["usuario"].ToString(), Session["pass"].ToString(),txtComentarios.Value,Session["NombreApellido"].ToString(),
                        ...
                        "SI", "Rechazados Compras", lblTipoGestion.Text);

                    lg.insertarComentario(Session["NombreApellido"].ToString(), Convert.ToInt32(lblID.Text), txtComentarios.InnerText, ddlNroOC.SelectedValue, lblTipoGestion.Text, ddlMovimiento.SelectedItem.ToString(), "Rechazados Compras", ddlDepartamento.SelectedItem.ToString());

                    lg.insertarDatosReporteStatusFacturaPowerBI("Rechazados Compras", ddlDepartamento.SelectedItem.ToString(), Convert.ToInt32(lblID.Text), Session["NombreApellido"].ToString(),
