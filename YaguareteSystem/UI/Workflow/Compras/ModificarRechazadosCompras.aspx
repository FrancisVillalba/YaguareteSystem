<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModificarRechazadosCompras.aspx.cs" Inherits="YaguareteSystem.UI.Workflow.Compras.ModificarRechazadosCompras" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Datos de facturas rechazadas para compras</h1>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
