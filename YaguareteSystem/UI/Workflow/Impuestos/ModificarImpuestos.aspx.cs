...
{
    public partial class ModificarImpuestos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (lblControl.InnerText == "")
            {
                ...
                lblDepartamento.Text = "Impuestos";
        ...
        {
            Response.Redirect("/UI/Workflow/Impuestos/Impuestos.aspx");
        }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (mensaje == "OK")
                {
                    ...
                    sharePoint.ActualizaMotivosImpuestos(Convert.ToInt64(lblID.Text), Session["usuario"].ToString(), Session["pass"].ToString(),
                      txtComentarios.Value, Session["NombreApellido"].ToString(), ddlMovimiento.SelectedItem.ToString(),
                      ddlDepartamento.SelectedValue, ddlMovimiento.SelectedValue, 
                      ddlDepartamento.SelectedItem.ToString(), "SI", lblDepartamento.Text, lblTipoGestion.Text);

                    lg.insertarComentario(Session["NombreApellido"].ToString(), Convert.ToInt32(lblID.Text), txtComentarios.InnerText, ddlNroOC.SelectedValue, lblTipoGestion.Text, ddlMovimiento.SelectedItem.ToString(), lblDepartamento.Text, ddlDepartamento.SelectedItem.ToString());

                    lg.insertarDatosReporteStatusFacturaPowerBI("Impuestos", ddlDepartamento.SelectedItem.ToString(), Convert.ToInt32(lblID.Text), Session["NombreApellido"].ToString(),
