...
{
    public partial class ModificarRechazadosRecepcion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (lblControl.InnerText == "")
            {
                ...
                lblDepartamento.Text = "RechazadosRecepcion";
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (mensaje == "OK")
                {
                    ...
                    sharePoint.ActualizaMotivosRevisionCompras(Convert.ToInt64(lblID.Text), Session["usuario"].ToString(), Session["pass"].ToString(),txtComentarios.Value,Session["NombreApellido"].ToString(),
                        ddlMovimiento.SelectedItem.ToString(),ddlDepartamento.SelectedValue,ddlMovimiento.SelectedValue, ddlDepartamento.SelectedItem.ToString(),
                        "SI", "Rechazados Recepción", lblTipoGestion.Text);

                    lg.insertarComentario(Session["NombreApellido"].ToString(), Convert.ToInt32(lblID.Text), txtComentarios.InnerText, ddlNroOC.SelectedValue, lblTipoGestion.Text, ddlMovimiento.SelectedItem.ToString(), "Rechazados Recepción", ddlDepartamento.SelectedItem.ToString());

                    lg.insertarDatosReporteStatusFacturaPowerBI("Rechazados Recepción", ddlDepartamento.SelectedItem.ToString(), Convert.ToInt32(lblID.Text), Session["NombreApellido"].ToString(),
