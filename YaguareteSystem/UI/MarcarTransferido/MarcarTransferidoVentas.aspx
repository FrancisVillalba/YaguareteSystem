<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MarcarTransferidoVentas.aspx.cs" Inherits="YaguareteSystem.UI.MarcarTransferido.MarcarTransferidoVentas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Marcar como transferido para ventas</h1>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
